...
Define a extração de notícias do Plantão B3 via `ListarTitulosNoticias`, com filtros de agência, palavra-chave e período, cache de 1 hora e conversão para a entidade `NoticiaB3`.
