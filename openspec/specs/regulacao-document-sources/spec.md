...
Define as fontes de documentos `MaterialFactsSource` e `NoticiasSource` para alimentar o VectorStore do `llm-chat` com dados regulatórios e de mercado da B3, implementando o ABC `DocumentSource`.
