...
Define a extração de fatos relevantes, assembleias e avisos via `GetMaterialFacts` da B3, com token Base64, paginação automática e mapeamento por categoria para entidades de domínio.
