...
Define a resolução de tickers para o identificador interno `idFNET` na API de fundos listados da B3, com cache do resultado (inclusive `None`) e retorno gracioso quando o ticker não é um fundo listado.
