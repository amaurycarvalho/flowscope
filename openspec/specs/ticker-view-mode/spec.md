...
O sistema DEVE exibir um botão do tipo toggle (checkbutton com `indicatoron=0`) com o ícone `document-edit.png` na barra superior entre "Salvar" e "Selecionar Todos". Botão marcado = modo edição; desmarcado = modo visualização.
