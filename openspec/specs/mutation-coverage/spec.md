...
Define mutation-testing coverage requirements to eliminate surviving mutants across the flowscope codebase, using mutmut to verify that tests kill mutations in infrastructure, domain, and application modules.
