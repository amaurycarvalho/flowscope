...
Define o pipeline de extração de rendimentos e amortizações estruturados da B3 (type=41): listagem paginada de documentos, cache, extração de detalhes por documento, orquestração por use case e exposição via CLI.
