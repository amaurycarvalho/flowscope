...
- **Documento vinculado sob demanda**: quando o corpo da notícia "Geral" é apenas um apontador para um documento — na CVM RAD (`rad.cvm.gov.br`, ex.: "Esclarecimentos de questionamentos CVM/B3") ou no FNET (`fnet.bmfbovespa.com.br`, ex.: esclarecimentos e avisos de oferta de FIIs) —, o conteúdo é baixado ao selecionar a notícia e ao processar "Resumir pendentes", extraído e cacheado, substituindo o apontador no corpo; captcha habilitado, falha ou formato inesperado mantém o corpo original.
