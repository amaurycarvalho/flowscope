...
- [ ] 3.1 Criar o change `refactor-correlation-network-layers` (extração de séries para `application`) e verificar com `openspec validate refactor-correlation-network-layers`
