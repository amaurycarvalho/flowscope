...
class TimelineRow:
    """CLV, eficiência e fluxo monetário de um ativo em um pregão."""
...
def build_rows(info: dict) -> list[TimelineRow]:
...
def direction_balance(rows: list[TimelineRow]) -> tuple[int, int]:
